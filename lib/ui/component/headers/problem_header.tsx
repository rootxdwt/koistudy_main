...
export const Header = (props: { forwardNavigatable?: { target: number }, backwardNavigatable?: { target: number }, sideMenuToggleFn: Function }) => {
      ...
      {isLoaded ? <>
        < HeaderComp isTop={props.forwardNavigatable || props.backwardNavigatable} >
          <div className="contentHolder">
            <ProbNavBtn onClick={()=>props.sideMenuToggleFn()}>
              <FiMenu />
            </ProbNavBtn>
